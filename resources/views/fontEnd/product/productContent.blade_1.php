        ...
        <div class="col-md-6 single-right-left animated wow slideInUp animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInUp;">
            <div class="grid images_3_of_2">
                <div class="flexslider">
                    ...
                    <!-- //FlexSlider-->
                    <ul class="slides">
                        <li data-thumb="{{asset('public/fontEnd/images/')}}/d2.jpg">
                            <div class="thumb-image"> <img src="{{asset('public/fontEnd/images/')}}/d2.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li>
                        <li data-thumb="{{asset('public/fontEnd/images/')}}/d1.jpg">
                            <div class="thumb-image"> <img src="{{asset('public/fontEnd/images/')}}/d1.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li>	
                        <li data-thumb="{{asset('public/fontEnd/images/')}}/d3.jpg">
                            <div class="thumb-image"> <img src="{{asset('public/fontEnd/images/')}}/d3.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li>
                        <li data-thumb="{{asset('public/fontEnd/images/')}}/d4.jpg">
                            <div class="thumb-image"> <img src="{{asset('public/fontEnd/images/')}}/d4.jpg" data-imagezoom="true" class="img-responsive"> </div>
                        </li>	
                    </ul>
