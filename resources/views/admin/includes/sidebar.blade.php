...
<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Manufacturar<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
                        <a href="{{url('/manufacturar/add')}}">Add Manufacturar</a>
                    </li>
                    <li>
                        <a href="{{url('/manufacturar/manage')}}">Manage Manufacturar</a>
                    </li>
                </ul>
                <!-- /.nav-second-level -->
            </li>
